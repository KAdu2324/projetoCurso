...
import com.educaweb.course.entities.OrderStatus;
...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		User u2 = new User(null, "Valdevino João", "joao@gmail.com", "98665", "987654");
		User u3 = new User(null, "mario João", "joao@gmail.com", "9687", "958756");
		...
		Payment pay1 = new Payment(1, Instant.parse("2019-06-20T21:53:07Z"), o1);
		o1.setPayment(pay1);
